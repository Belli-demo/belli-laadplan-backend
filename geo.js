    ...
    for (let i = 0; i < origineel.wijken.length; i++) {
      ...
      await pool.query(`
        ...
        ON CONFLICT (id, gemeente_id) DO UPDATE SET
          naam=$3, inwoners=$4, voertuigen=$5, aandeel_app=$6, lat=$7, lng=$8,
          wijktype=$9, seg_bewoners=$10, seg_bezoekers=$11, seg_logistiek=$12, seg_ov=$13`,
        [w.id, gemeenteId, w.naam, w.inw, w.vrt, w.app, w.lat, w.lng, w.type,
